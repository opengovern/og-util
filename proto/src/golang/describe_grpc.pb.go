...
const (
	DescribeService_DeliverResult_FullMethodName         = "/kaytu.describe.v1.DescribeService/DeliverResult"
	DescribeService_SetInProgress_FullMethodName         = "/kaytu.describe.v1.DescribeService/SetInProgress"
	DescribeService_DeliverAWSResources_FullMethodName   = "/kaytu.describe.v1.DescribeService/DeliverAWSResources"
	DescribeService_DeliverAzureResources_FullMethodName = "/kaytu.describe.v1.DescribeService/DeliverAzureResources"
)
...
func (c *describeServiceClient) DeliverAWSResources(ctx context.Context, in *AWSResources, opts ...grpc.CallOption) (*ResponseOK, error) {
	out := new(ResponseOK)
	err := c.cc.Invoke(ctx, DescribeService_DeliverAWSResources_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *describeServiceClient) DeliverAzureResources(ctx context.Context, in *AzureResources, opts ...grpc.CallOption) (*ResponseOK, error) {
	out := new(ResponseOK)
	err := c.cc.Invoke(ctx, DescribeService_DeliverAzureResources_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DescribeService_DeliverAWSResources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DescribeService_DeliverAWSResources_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DescribeService_DeliverAzureResources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DescribeService_DeliverAzureResources_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
