...
const (
	EsSinkService_Ingest_FullMethodName = "/opengovernance.es_sink.v1.EsSinkService/Ingest"
)
...
func (c *esSinkServiceClient) Ingest(ctx context.Context, in *IngestRequest, opts ...grpc.CallOption) (*ResponseOK, error) {
	out := new(ResponseOK)
	err := c.cc.Invoke(ctx, EsSinkService_Ingest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EsSinkService_Ingest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EsSinkService_Ingest_FullMethodName,
	}
...
var EsSinkService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "opengovernance.es_sink.v1.EsSinkService",
